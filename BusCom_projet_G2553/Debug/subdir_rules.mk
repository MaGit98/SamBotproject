...
Motor.obj: ../Motor.c $(GEN_OPTS) | $(GEN_HDRS)
	...
	"D:/Logiciels/Code Composer Studio/CCS/ccsv8/tools/compiler/ti-cgt-msp430_18.1.2.LTS/bin/cl430" -vmsp --use_hw_mpy=none --include_path="D:/Logiciels/Code Composer Studio/CCS/ccsv8/ccs_base/msp430/include" --include_path="D:/Logiciels/Code Composer Studio/workspace_v8/SamBotproject/BusCom_projet_G2553" --include_path="D:/Logiciels/Code Composer Studio/CCS/ccsv8/tools/compiler/ti-cgt-msp430_18.1.2.LTS/include" --advice:power=all --define=__MSP430G2553__ -g --printf_support=minimal --diag_warning=225 --diag_wrap=off --display_error_number --preproc_with_compile --preproc_dependency="Motor.d_raw" $(GEN_OPTS__FLAG) "$<"
